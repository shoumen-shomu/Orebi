  ...
  return (
    <div className="group">
      <div className="relative bg-[#F3F3F3] ">
        ...
        {/* Hover Part Start */}
        <div className="p-5 bg-white absolute bottom-0 left-0 opacity-0 translate-y-5 group-hover:opacity-90 group-hover:translate-y-0 duration-500 w-full ">
          <Flex className={"justify-end-safe gap-x-3.5"}>
            <h5 className="font-sans font-normal text-4 text-secendary hover:text-primary duration-500 hover:font-bold">
              Add to Wish List
            </h5>
            <FaHeart />
          </Flex>
